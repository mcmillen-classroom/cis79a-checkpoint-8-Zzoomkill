package com.jiedong.myplaceapp;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
        ...
        if (requestCode == RESULT_OK && resultCode == REQUEST_PLACE_CREATE)
        {
            if(data != null)
            {
    ...
    {
        Intent editItent = new Intent (this,PlaceEditActivity.class);
        editItent.putExtra("place_position",position);
        editItent.putExtra("place_name",place.getName());
        editItent.putExtra("place_description",place.getDescription());
        startActivityForResult(editItent, REQUEST_PLACE_EDIT);
    }
